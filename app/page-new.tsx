...
import { TrendingIssuesBanner } from "@/components/trending-issues-banner";
...
export default function HomePage() {
  ...
  const handleLoadDemoData = () => {
    DemoReports.loadDemoData();
    toast({
      title: "Demo data loaded!",
      description: "Sample reports and comments have been loaded. Refresh to see the changes.",
    });
    setTimeout(() => {
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 text-sm">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-zinc-300">
                  {FavoritesStorage.getFavorites().length} saved
                </span>
              </div>
            </div>
          </div>

          {/* Trending Issues Banner */}
          <TrendingIssuesBanner
